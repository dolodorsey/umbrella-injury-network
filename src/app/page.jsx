...
const SVCS = [{n:"Attorney Referral",d:"Top PI attorneys matched by case type and location."},{n:"Medical Providers",d:"Chiropractors, orthopedics, and diagnostic centers."},{n:"Case Management",d:"Coordination between legal, medical, and insurance."},{n:"Insurance Claims",d:"Filing support, documentation, and settlement negotiation."}];
...
export default function Home() {
  ...
  return (<>
    ...
    <div style={{position:'fixed',top:0,left:0,width:'100%',height:'100%',background:'#14161B',zIndex:10000,display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',opacity:ld?0:1,visibility:ld?'hidden':'visible',transition:'opacity 1s cubic-bezier(0.16,1,0.3,1),visibility 1s'}}>
      <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/umbrella_injury/00-brand-assets/logos/hurt-911-logo-black.png" alt="" style={{width:120,objectFit:'contain',marginBottom:16,animation:'pulse 2s ease-in-out infinite'}} />
    ...
    <nav style={{position:'fixed',top:0,left:0,width:'100%',zIndex:1000,padding:'20px clamp(20px,4vw,80px)',display:'flex',alignItems:'center',justifyContent:'space-between',background:sc?'rgba(10,10,14,0.92)':'transparent',backdropFilter:sc?'blur(16px)':'none',transition:'background 0.4s'}}>
      <a href="#" style={{display:'flex',alignItems:'center',gap:12,textDecoration:'none'}}>
        <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/umbrella_injury/00-brand-assets/logos/hurt-911-logo-black.png" alt="" style={{height:28,objectFit:'contain'}} />
      </a>
    ...
    <section style={{position:'relative',height:'100vh',overflow:'hidden',display:'flex',flexDirection:'column',justifyContent:'center',background:'#14161B'}}>
      ...
      <div style={{position:'relative',zIndex:4,maxWidth:620,padding:'0 clamp(20px,4vw,80px)'}}>
        <div style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(8px,0.7vw,10px)',letterSpacing:'0.35em',textTransform:'uppercase',color:'#B4975A',marginBottom:20,animation:'fadeUp 0.8s cubic-bezier(0.16,1,0.3,1) 2.2s both'}}>Umbrella Injury Network × The Kollective</div>
        <h1 style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(36px,7vw,90px)',fontWeight:300,lineHeight:1.08,letterSpacing:'-0.02em',color:'#F7F7F4',margin:0,animation:'fadeUp 1s cubic-bezier(0.16,1,0.3,1) 2.4s both'}}>Injured? One call.<br />We handle<br />the <em style={{fontStyle:'italic',color:'#8B2500'}}>rest.</em></h1>
        <p style={{fontSize:'clamp(13px,1.2vw,16px)',color:'rgba(247,247,244,0.45)',lineHeight:1.7,maxWidth:440,marginTop:24,animation:'fadeUp 0.8s cubic-bezier(0.16,1,0.3,1) 2.6s both'}}>Immediate connection to vetted personal injury attorneys, medical providers, and case managers.</p>
    ...
    <section id="services" style={{position:'relative',padding:'clamp(80px,10vw,140px) clamp(20px,4vw,80px)',background:'#14161B'}}>
      ...
      <div style={{maxWidth:1400,margin:'0 auto',position:'relative',zIndex:1}}>
        <div ref={addR} style={{opacity:0,transform:'translateY(35px)',transition:'opacity 0.8s cubic-bezier(0.16,1,0.3,1),transform 0.8s cubic-bezier(0.16,1,0.3,1)'}}>
          ...
          <h2 style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(28px,5vw,64px)',fontWeight:300,lineHeight:1.1,letterSpacing:'-0.02em',color:'#F7F7F4',marginBottom:48}}>What we <em style={{fontStyle:'italic',color:'#8B2500'}}>deliver.</em></h2>
        </div>
    ...
    <div style={{position:'relative',height:'clamp(280px,40vw,450px)',overflow:'hidden'}}>
      ...
      <div style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',display:'flex',alignItems:'center',justifyContent:'flex-start',padding:'0 clamp(40px,6vw,120px)'}}>
        <div style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(22px,4vw,52px)',fontWeight:300,fontStyle:'italic',color:'#B4975A',maxWidth:550,lineHeight:1.3,textShadow:'0 2px 20px rgba(0,0,0,0.8)'}}>&ldquo;Personal Injury Referral Network — built different.&rdquo;</div>
      </div>
    </div>
      ...
      <div style={{maxWidth:1400,margin:'0 auto',position:'relative',zIndex:1}}>
        <div ref={addR} style={{opacity:0,transform:'translateY(35px)',transition:'opacity 0.8s cubic-bezier(0.16,1,0.3,1),transform 0.8s cubic-bezier(0.16,1,0.3,1)'}}>
          <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:32}}>
            <div style={{width:40,height:1,background:'#8B2500'}} />
            <div style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(8px,0.7vw,10px)',letterSpacing:'0.35em',textTransform:'uppercase',color:'#8B2500'}}>A Kollective Company</div>
          </div>
          <h2 style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(26px,4.5vw,56px)',fontWeight:300,lineHeight:1.1,letterSpacing:'-0.02em',color:'#14161B',marginBottom:24}}>Part of something <em style={{fontStyle:'italic',color:'#8B2500'}}>bigger.</em></h2>
          <p style={{fontSize:'clamp(14px,1.3vw,18px)',color:'rgba(20,22,27,0.5)',lineHeight:1.8,maxWidth:600,marginBottom:40}}>Umbrella Injury Network operates under The Kollective Hospitality Group — a multi-brand enterprise spanning events, food & beverage, museums, consumer products, technology, and wellness across 8 cities.</p>
          <div style={{display:'flex',gap:'clamp(24px,4vw,56px)',flexWrap:'wrap'}}>
            {[{n:'57+',l:'Ventures'},{n:'8',l:'Cities'},{n:'198',l:'AI Agents'},{n:'34',l:'Departments'}].map((s,i) => (
              <div key={i}>
                <div style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(28px,3.5vw,48px)',fontWeight:300,color:'#8B2500',lineHeight:1}}>{s.n}</div>
    ...
    <section id="connect" style={{position:'relative',padding:'clamp(80px,10vw,140px) clamp(20px,4vw,80px)',background:'#14161B',overflow:'hidden'}}>
      ...
      <div style={{maxWidth:900,margin:'0 auto',textAlign:'center',position:'relative',zIndex:1}}>
        <div ref={addR} style={{opacity:0,transform:'translateY(35px)',transition:'opacity 0.8s cubic-bezier(0.16,1,0.3,1),transform 0.8s cubic-bezier(0.16,1,0.3,1)'}}>
          <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/umbrella_injury/00-brand-assets/logos/hurt-911-logo-black.png" alt="" style={{width:80,objectFit:'contain',margin:'0 auto 24px',display:'block',opacity:0.6}} />
          <h2 style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(28px,5vw,64px)',fontWeight:300,lineHeight:1.1,color:'#F7F7F4',marginBottom:24}}>{"Let's"} <em style={{fontStyle:'italic',color:'#8B2500'}}>connect.</em></h2>
          <p style={{fontSize:'clamp(14px,1.3vw,18px)',color:'rgba(247,247,244,0.45)',lineHeight:1.7,maxWidth:560,margin:'0 auto 48px'}}>Immediate connection to vetted personal injury attorneys, medical providers, and case managers.</p>
          <div style={{display:'flex',gap:20,justifyContent:'center',flexWrap:'wrap',marginBottom:56}}>
            <a href="mailto:thedoctordorsey@gmail.com?subject=Umbrella Injury Network Inquiry" style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(8px,0.7vw,10px)',letterSpacing:'0.2em',textTransform:'uppercase',color:'#14161B',background:'#B4975A',padding:'14px 36px',textDecoration:'none'}}>Get In Touch</a>
    ...
    <footer className="ftr" style={{padding:'40px clamp(20px,4vw,80px)',borderTop:'1px solid rgba(247,247,244,0.06)',display:'flex',alignItems:'center',justifyContent:'space-between',background:'#14161B'}}>
      <div style={{display:'flex',alignItems:'center',gap:12}}>
        <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/umbrella_injury/00-brand-assets/logos/hurt-911-logo-black.png" alt="" style={{height:20,objectFit:'contain',opacity:0.4}} />
        <div style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(7px,0.65vw,9px)',letterSpacing:'0.2em',color:'rgba(247,247,244,0.3)'}}>© 2026 Umbrella Injury Network</div>
      </div>
